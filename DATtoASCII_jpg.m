...
h2=plot([S1.X],[S1.Y],'k');
file_image=sprintf('radar_rainfal_%04d.jpg',i);
saveas(gcf,file_image);
%--------------------------------
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
imageNames=dir(fullfile(myPath,'r*.jpg'));
imageNamess={imageNames.name};
outputVideo = VideoWriter(fullfile(myPath,'radar_rainfall.avi'));
open(outputVideo)
for ii = 1:length(imageNames)
   img = imread(fullfile(myPath,imageNamess{ii}));
